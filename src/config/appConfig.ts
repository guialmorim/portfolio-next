	...
	user: {
		...
		posts: [
			...
			},
			{
				...
				title: 'Next Store',
				description:
					'Um e-commerce completo usando Next.js, Typescript, MongoDB, Chakra-UI e Styled Components para estilização, projetado com simplicidade para aprendizado e também focado em uma aplicabilidade no mundo real.',
				cover: '/portfolio/nextstore.png',
				created: '2020-03-20',
				url: 'https://next-store-guialmorim.vercel.app',
			},
			{
				id: '4',
				featured: false,
				...
				description:
					'Desenvolvimento de um cardapio em forma de aplicação web, com a possibilidade de visualizar os modelos 3D dos pratos, mas uma imagem vale mais que mil palavras, então clica no link abaixo e da uma olhada!',
